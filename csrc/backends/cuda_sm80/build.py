"""CUDA SM80 source graph. SM90 algorithms get a different builder."""
import os
from setuptools import setup

if globals().get("GDN_SELECTED_TARGET") != "cuda_sm80":
    raise RuntimeError("CUDA SM80 builder rejects another target; use its own source graph")

from torch.utils.cpp_extension import BuildExtension, CUDAExtension
CUTLASS_INCLUDE = os.path.join(HERE, _backend["dependency"], "include")
