...
#if defined(GDN_SM90_SHARED_STATE) && GDN_SM90_SHARED_STATE == 3
    using Types = ValueKernelTypes<Gate,Initial,128,136,true,2,176>;
#elif defined(GDN_SM90_SHARED_STATE) && GDN_SM90_SHARED_STATE == 2
