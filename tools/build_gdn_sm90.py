...
def main():
    ...
    p.add_argument("--output-stash",type=int,choices=(1,2),
                   help="owner-private FP32 O1 stash:1 originalroles,2 aux168/state160")
    ...
    if args.output_stash is not None:
        options += [f"-DGDN_SM90_STATE_OUTPUT_STASH={args.output_stash}"]
